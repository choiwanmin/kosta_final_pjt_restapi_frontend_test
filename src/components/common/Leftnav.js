    ...
    return(
        <nav class="w_bg nav_vertical left_wrapper">
            ...
            <div class="left_footer">
                    <Link to="/join" class="out_link">
                        <div class="icon_wrapper">
                            <i class="fa-solid fa-gear"></i>
                        </div>
                        <span class="nav_link_text">설정</span>
                    </Link>
                    <a class="out_link" onClick={logout}>
                        <div class="icon_wrapper">
                            <i class="fa-solid fa-right-from-bracket"></i>
                        </div>
                        <span class="nav_link_text">로그아웃</span>
                    </a>
            </div>
        </nav>
    )
...
function Emp(props){
    return(
        <>
        <p class="nav_main_title">HRM system</p>
        <ul>
            <li class="li_link">
                <Link to="/" class="nav_link">
                    ...
                    <span class="nav_link_text">홈</span>
                </Link>
            </li>
            <li class="li_link">
                <Link to="/" class="nav_link">
                    <div class="icon_wrapper">
                        <svg  class="nav_link_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                    </div>
                    <span class="nav_link_text">내 인사카드 관리</span>
                </Link>
            </li>
            <li class="li_link">
                <Link to="/myrecord" class="nav_link">
                    <div class="icon_wrapper">
                        <svg  class="nav_link_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 352h8.2c32.3-39.1 81.1-64 135.8-64c5.4 0 10.7 .2 16 .7V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM320 352H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H360.2C335.1 449.6 320 410.5 320 368c0-5.4 .2-10.7 .7-16l-.7 0zm320 16a144 144 0 1 0 -288 0 144 144 0 1 0 288 0zM496 288c8.8 0 16 7.2 16 16v48h32c8.8 0 16 7.2 16 16s-7.2 16-16 16H496c-8.8 0-16-7.2-16-16V304c0-8.8 7.2-16 16-16z"/></svg>
                    </div>
                    <span class="nav_link_text">출퇴근 관리</span>
                </Link>
            </li>
            {
              props.dept > 0 ?
            ...
            <li class="nav_li" style={{paddingTop:"10px"}}>
                <div>
                 <p class="nav_main_title">connect system</p>
                <ul>
                    <li class="li_link">
                        <Link to="/" class="nav_link">
                            <div class="icon_wrapper">
                            ...
                            <span class="nav_link_text">공지게시판</span>
                        </Link>
                    </li>
                    <li class="li_link">
                        <Link to="/" class="nav_link">
                            ...
                            <span class="nav_link_text">채팅</span>
                        </Link>
                    </li>
                    <li class="li_link">
                        <Link to="/" class="nav_link">
                            <div class="icon_wrapper">
                                <svg  class="nav_link_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zm384 64H256V0L384 128z"/></svg>
                            </div>
                            <span class="nav_link_text">문서함</span>
                         </Link>
                    </li>
                </ul>
            </div>
             ...
             <ul>
                ...
                <li class="li_link">
                    <Link to="/admin-record" class="nav_link">
                      ...
                      <span class="nav_link_text">사원 근태관리</span>
                    </Link>
                </li>
                <li class="li_link">
                    <Link to="/" class="nav_link">
                      ...
                      <span class="nav_link_text">사용자목록</span>
                    </Link>
                </li>
                <li class="li_link">
                  <Link to="/" class="nav_link">
                    ...
                    <span class="nav_link_text">부서목록</span>
                  </Link>
                </li>
                <li class="li_link">
                  <Link to="/" class="nav_link">
                    <div class="icon_wrapper">
                      <svg  class="nav_link_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M384 64c0-17.7 14.3-32 32-32H544c17.7 0 32 14.3 32 32s-14.3 32-32 32H448v96c0 17.7-14.3 32-32 32H320v96c0 17.7-14.3 32-32 32H192v96c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32h96V320c0-17.7 14.3-32 32-32h96V192c0-17.7 14.3-32 32-32h96V64z"/></svg>
                    </div>
                    <span class="nav_link_text">직급목록</span>
                  </Link>
                </li>
              </ul>
          </>
