    ...
    return(
        <nav class="w_bg nav_vertical left_wrapper">
            ...
            <div className="left_footer">
                    <Link to="/join" className="out_link">
        ...
        <>
            <p className="nav_main_title">HRM system</p>
             <ul>
                ...
                <li className="li_link">
                    <Link to="/admin-record" className="nav_link">
                      <div className="icon_wrapper">
                        <svg  className="nav_link_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M160 80c0-26.5 21.5-48 48-48h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H208c-26.5 0-48-21.5-48-48V80zM0 272c0-26.5 21.5-48 48-48H80c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V272zM368 96h32c26.5 0 48 21.5 48 48V432c0 26.5-21.5 48-48 48H368c-26.5 0-48-21.5-48-48V144c0-26.5 21.5-48 48-48z"/></svg>
                      </div>
